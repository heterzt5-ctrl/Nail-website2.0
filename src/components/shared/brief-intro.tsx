...
export default function BriefIntro() {
    ...
    const text: Record<string, string> = {
        ...
        EN: "REMY MUSE is a modern nail atelier. Crafted with intention. Designed for you.",
    ...
    return (
        <section className="py-32 px-8 md:px-20 bg-surface-variant/20 overflow-hidden">
            <motion.div 
